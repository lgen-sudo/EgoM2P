...
from egom2p.data import build_mixture_dataloader, get_train_dataloader, get_val_dataloader, setup_sampling_mod_info
from egom2p.models import egom2p_model
...
from egom2p.utils import create_model
...
def get_args():
    ...
    parser = argparse.ArgumentParser('EgoM2P pre-training script (using DDP)', add_help=True)
    ...
    # Model parameters
    parser.add_argument('--model', default='egom2p_base_12e_12d_swiglu_nobias', type=str,
    ...
    # Text tokenizer
    parser.add_argument('--text_tokenizer_path', default='egom2p/utils/tokenizer/trained/text_tokenizer_4m_wordpiece_30k.json',
