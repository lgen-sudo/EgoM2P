...
from egom2p.utils.timm.registry import register_model
from huggingface_hub import PyTorchModelHubMixin

from .egom2p_utils import Block, DecoderBlock, LayerNorm
...
__all__ = [
    # GELU models
    'egom2p_tiny_6e_6d_gelu',
    'egom2p_small_8e_8d_gelu',
    'egom2p_base_12e_12d_gelu',
    'egom2p_large_24e_24d_gelu',
    'egom2p_xlarge_24e_24d_gelu',
    # SwiGLU models
    'egom2p_tiny_6e_6d_swiglu_nobias',
    'egom2p_small_8e_8d_swiglu_nobias',
    'egom2p_base_12e_12d_swiglu_nobias',
    'egom2p_base_12e_12d_swiglu_nobias_causal',
    'egom2p_large_24e_24d_swiglu_nobias',
    'egom2p_xlarge_24e_24d_swiglu_nobias',
    # SwiGLU + QKNorm models
    'egom2p_base_12e_12d_swiglu_qknorm_nobias',
    'egom2p_large_24e_24d_swiglu_qknorm_nobias',
    'egom2p_xlarge_24e_24d_swiglu_qknorm_nobias',
]



class EgoM2P(nn.Module):
    """EgoM2P model.
    ...
    def forward_loss(self, 
        ...
        elif loss_type in ['weighted_mod']:
            loss, mod_loss = self.forward_weighted_mod_loss(y, target_ids, decoder_mod_dict, decoder_mod_mask)
    ...
    def forward_weighted_mod_loss(self, 
                         y: torch.Tensor, 
                         target_ids: torch.Tensor, 
                         decoder_mod_dict: Dict[str, Any], 
...
class FM(EgoM2P, PyTorchModelHubMixin):
    """Wrapper around EgoM2P for easy loading with Huggingface Hub.
...
@register_model
def egom2p_xlarge_24e_24d_gelu(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
# SwiGLU variants
@register_model
def egom2p_tiny_6e_6d_swiglu_nobias(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
@register_model
def egom2p_small_8e_8d_swiglu_nobias(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
@register_model
def egom2p_base_12e_12d_swiglu_nobias_causal(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
@register_model
def egom2p_base_12e_12d_swiglu_nobias(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
@register_model
def egom2p_large_24e_24d_swiglu_nobias(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
@register_model
def egom2p_xlarge_24e_24d_swiglu_nobias(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
@register_model
def egom2p_base_12e_12d_swiglu_qknorm_nobias(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
@register_model
def egom2p_large_24e_24d_swiglu_qknorm_nobias(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
...
@register_model
def egom2p_xlarge_24e_24d_swiglu_qknorm_nobias(
        encoder_embeddings: Dict[str, nn.Module],
        decoder_embeddings: Dict[str, nn.Module],
        **kwargs):
    model = EgoM2P(
