...
from egom2p.data.modality_transforms import AbstractTransform, get_transform_key
...
class MultiModalDatasetFolder(VisionDataset):
    ...
    def __init__(
        ...
        classes, class_to_idx = self._find_classes(os.path.join(self.root, 'rgb'))
