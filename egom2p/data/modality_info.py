...
from egom2p.data.modality_transforms import (CaptionTransform, DepthTransform,
...
from egom2p.models.decoder_embeddings import (ImageTokenDecoderEmbedding, VideoTokenDecoderEmbedding,
                                             GazeCamTokenDecoderEmbedding, SequenceDecoderEmbedding)
from egom2p.models.encoder_embeddings import (ImageEncoderEmbedding,
...
from egom2p.utils import generate_uint15_hash
...
MODALITY_INFO = {
    ...
    'tok_rgb': { # for rgb video
        ...
        'patch_size': 8,
        'vocab_size': 64000,
        'encoder_embedding': partial(VideoTokenEncoderEmbedding, vocab_size=64000, patch_size=(4, 8, 8), image_size=256),
        'decoder_embedding': partial(VideoTokenDecoderEmbedding, vocab_size=64000, patch_size=(4, 8, 8), image_size=256),
        'min_tokens': 0,
        'max_tokens': 5120, 
        'type': 'img',
